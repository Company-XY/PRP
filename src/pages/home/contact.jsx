...
const Contact = () => {
  return (
    <div className="bg-white h-full">
      ...
      <div className="w-full p-5 my-6 ml-10 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl bg-gradient-to-r from-grey to-black">
        <div className="flex">
          <h1 className="font-bold text-white text-3xl">Talk To Us</h1>
        </div>
      ...
      <div className="w-full mr-1 mb-8 lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-blue-900 rounded-2xl bg-gradient-to-r from-grey to-black">
        <div className="flex flex-col text-white">
          <h1 className="font-bold text-2xl my-4">Drop in at our office</h1>
